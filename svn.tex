...
[root@CentOS svn]# svn import&\index{svn@\svn!\svnim}& -m 'Create trunk, branches, tags directory structure' /tmp/svn-template/ http://127.0.0.1/svn/project_repo -m 'Create trunk, branches, tags directory structure' --username tom
...
步. 因为仓库是共享的, 所以其他开发人员会向仓库提交他们的修改, 这时候你的工作副
本就会变成过时了的.
