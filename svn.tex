...
[root@CentOS svn]# svn import&\index{svn@\svn!\svnim}& /tmp/svn-template/ \
...
访问权限控制:
\begin{svnshell}
[tom@CentOS ~]$ svn checkout&\index{svn@\svn!\svnco}& http://localhost/svn/project_repo \
> --username=tom
